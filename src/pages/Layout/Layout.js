...
import './Layout.css';
import dvdLogo from '../../assets/logo/dvd.svg'; // Ensure this path is correct
...
function Layout({ children }) {
  ...
  <div className="layout-background">
    <div className="navbar" style={{ display: isFullScreen ? 'none' : 'flex' }}>
      <ul>
        <li><NavLink to="/" className={isActive('/') ? 'nav-link nav-link-active' : 'nav-link'}>Home</NavLink></li>
